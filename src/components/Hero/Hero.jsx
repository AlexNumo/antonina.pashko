    ...
    <section className={styles.hero}>
      <div className={styles.copy}>
        ...
        <p className={styles.lead}>
          Ти більше не хочеш жити за інерцією, але поки не бачиш, як побудувати свій новий, автономний світ. Цей практикум — твій чіткий орієнтир і повернення до власної сили.
        </p>
